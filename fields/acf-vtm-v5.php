...
if (!class_exists('acf_field_vtm')):
    class acf_field_vtm extends acf_field
    {
        ...
        public function __construct($settings)
        {
            ...
            add_action('wp_ajax_acf/fields/vtm/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/vtm/query', [$this, 'ajax_query']);
        ...
        public function input_admin_enqueue_scripts()
        {
            ...
            // register & include JS
            wp_register_script('acf-input-vtm', "{$url}assets/js/input.js", ['acf-input'], $version);
            wp_enqueue_script('acf-input-vtm');

            // register & include CSS
            wp_register_style('acf-input-vtm', "{$url}assets/css/input.css", ['acf-input'], $version);
